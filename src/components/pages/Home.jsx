          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-[#31363F] mb-6">
                ...
                accessible to everyone while ensuring sustainability & pace at
            ...
            <div className="text-center p-6">
              <div className="w-16 h-16 bg-[#76ABAE]/20 rounded-lg flex items-center justify-center mx-auto mb-4">
                ...
                >
                  ...
                  <path
                    fillRule="evenodd"
                    d="M4 5a2 2 0 012-2v1a1 1 0 001 1h6a1 1 0 001-1V3a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm8 8a1 1 0 100-2h-3a1 1 0 100 2h3z"
                  />
                </svg>
              </div>
