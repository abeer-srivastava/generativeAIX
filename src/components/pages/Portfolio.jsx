    ...
    const Portfolio = ({ setCurrentPage }) => {
        ...
        return (
            <div>
                ...
                <section className="py-20 bg-white cursor-pointer">
                    <div className="container mx-auto px-4">
                        {/* Filters */}
                ...
                <section className="py-20 bg-gradient-to-r from-[#76ABAE] to-[#31363F]">
                    <div className="container mx-auto px-4 text-center text-white">
                        ...
                        className="bg-white text-[#222831] px-8 py-3 rounded cursor-pointer font-semibold hover:bg-gray-200 transition duration-300 transform hover:scale-105">
                            Contact Us
                        </button>
                    </div>
                </section>
