          ...
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm space-y-2 sm:space-y-0">
            <div className="flex flex-col sm:flex-row items-center space-y-1 sm:space-y-0 sm:space-x-4 mobile-contact-info">
              <div className="flex items-center space-x-1">
                ...
                <span className="text-xs sm:text-sm">{COMPANY_INFO.phone}</span>
              </div>
              <div className="flex items-center space-x-1">
                <Mail size={14} className="sm:w-4 sm:h-4" />
                <span className="text-xs sm:text-sm">
                  <a target="#" href="mailto:generativeaixtech@gmail.com">{COMPANY_INFO.email}</a>
                </span>
              </div>
            </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4">
            ...
            <div className="hidden sm:block">
              <h1 className="text-base sm:text-lg lg:text-xl xl:text-2xl font-bold text-[#76ABAE]">{COMPANY_INFO.name}</h1>
            </div>
          </div>
