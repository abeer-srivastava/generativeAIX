    ...
    <header className="bg-[#EEEEEE] shadow-lg sticky top-0 z-50">
        ...
        <div className="container mx-auto px-4 flex justify-between items-center text-sm">
          ...
          <div className="flex items-center space-x-3">
            <a href="https://www.facebook.com/profile.php?id=61578882025775">
              ...
              <Facebook
                size={16}
                className="hover:text-[#222831] cursor-pointer"
              />
            </a>
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-3">
            <img
              src="/images/icons/Logof.png"
              alt="Generative Aix Logo"
              className="w-50 h-35 object-contain rounded-lg bg-[#EEEEEE]"
            />
            <h1 className="text-2xl font-bold text-[#76ABAE]"></h1>
          </div>
